    ...
    public static void main(String[] args) {
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                showResult(label, button, checkBox, checkBox1, radioButton, radioButton1, textField, textArea, comboBox, labelResult);
            }
        });
...
//                }
    ...
    private static void showResult(JLabel label, JButton button, JCheckBox checkBox, JCheckBox checkBox1, JRadioButton radioButton, JRadioButton radioButton1, JTextField textField, JTextArea textArea, JComboBox comboBox, JLabel labelResult) {
        String result = "";
